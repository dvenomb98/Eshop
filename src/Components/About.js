  ...
  return (
    <div className="pb-12 pt-6 bg-white">
      <div className="container mx-auto px-5">
        <div className="">
          <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Performace market</h2>
          <p className="mt-2 text-3xl font-bold leading-8 tracking-tight text-neutral-900 sm:text-4xl">
            Different products, different quality!
          </p>
